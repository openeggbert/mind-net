...
#include "miniwiki/ProgressTracker.h"
#include "miniwiki/Utils.h"
#include "miniwiki/persistence/Impl/Sqlite/Migrations.h"
#include "miniwiki/persistence/Impl/Sqlite/Tables/MigrationTable.h"
...
INSERT INTO "MIGRATION" VALUES (1,0)
        ...
        bool migrate()
        {
            ...
            try
            {
                ...
                SQLite::Database db("./miniwiki.sqlite3", SQLite::OPEN_READWRITE | SQLite::OPEN_CREATE);
