...
{
    PropertyRepositoryImplSqlite::~PropertyRepositoryImplSqlite() = default;

    def_virtual_irepository_impl_cpp_methods(Property, PROPERTY)

    entity_fields PropertyRepositoryImplSqlite::convert_crow_json_rvalue_to_entity_fields(
