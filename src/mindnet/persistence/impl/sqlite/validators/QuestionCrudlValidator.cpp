...
namespace mindnet::persistence::impl::sqlite::validators
{
    ...
    operation_result QuestionCrudlValidator::can_create(db_ db, entity_fields& ef) const
    {
        // models::Map map;
        // map.from_values(ef);
        // err << map << commit;
    ...
    operation_result QuestionCrudlValidator::can_read(db_ db, int id) const
    {
        return "The validation is not yet implemented.";
    }

    operation_result QuestionCrudlValidator::can_update(db_ db, entity_fields& ef) const
    {
        return "The validation is not yet implemented.";
    }

    operation_result QuestionCrudlValidator::can_delete(db_ db, int id) const
    {
        return "The validation is not yet implemented.";
    }

    operation_result QuestionCrudlValidator::can_list(db_ db, string_map& filter) const
    {
        return "";
    }
