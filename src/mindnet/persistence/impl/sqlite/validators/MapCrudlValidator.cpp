...
namespace mindnet::persistence::impl::sqlite::validators{
    ...
    operation_result MapCrudlValidator::can_read(db_ d, int id) const
    {
        return "The validation is not yet implemented.";
    }

    operation_result MapCrudlValidator::can_update(db_ d, entity_fields& ef) const
    {
        return "The validation is not yet implemented.";
    }

    operation_result MapCrudlValidator::can_delete(db_ d, int id) const
    {
        return "The validation is not yet implemented.";
    }

    operation_result MapCrudlValidator::can_list(db_ d, std::map<std::string, std::string>& filter) const
    {
        return "";
    }
