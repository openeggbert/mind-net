...
{
    using validators::SuggestionReviewCrudlValidator;
    using mindnet::OperationResult;

    OperationResult SuggestionReviewCrudlValidator::validate_create(const RequestContext& ctx,
    ...
    OperationResult SuggestionReviewCrudlValidator::validate_update(const RequestContext& ctx, const Model& old_entity,
    ...
    OperationResult SuggestionReviewCrudlValidator::validate_delete(const RequestContext& ctx,
                                                                    const Model& entity) const
    {
        return {405, "Deleting suggestions is forbidden. "};
    }

    OperationResult SuggestionReviewCrudlValidator::validate_list(const RequestContext& ctx,
