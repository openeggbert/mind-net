...
#include "mindnet/plugins/core/validators/UserCrudlValidator.h"
...
{
    using validators::UserCrudlValidator;
    ...
    OperationResult UserCrudlValidator::validate_read(const RequestContext& ctx, const Model& entity) const
    {
        return ok_result;
    }
    ...
    OperationResult UserCrudlValidator::validate_delete(const RequestContext& ctx, const Model& entity) const
    {
        return OperationResult(403, "You are not allowed to delete this user");
    }

    OperationResult UserCrudlValidator::validate_list(const RequestContext& ctx, const string_map& filter) const
    {
        return ok_result;
    }
