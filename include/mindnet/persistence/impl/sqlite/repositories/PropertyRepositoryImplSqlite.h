...
#include "mindnet/persistence/api/PropertyRepository.h"
...
namespace mindnet::impl::sqlite::repositories
{
    ...
    class PropertyRepositoryImplSqlite : public persistence::api::PropertyRepository
    {
    public:
        PropertyRepositoryImplSqlite() = default;
        ~PropertyRepositoryImplSqlite() override;
