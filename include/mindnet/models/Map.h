...
namespace mindnet::models
{
    ...
    .add_custom_list_action("note",{"map_id","{id}"})
    .add_custom_create_action("note", {"map_id","{id}"})
    .add_custom_list_action("tag_type",{"map_id","{id}"})
    .add_custom_create_action("tag_type",{"map_id","{id}"});
