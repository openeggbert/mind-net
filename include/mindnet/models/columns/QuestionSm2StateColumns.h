 ...
 */
#ifndef QUESTIONSM2STATECOLUMNS_H
#define QUESTIONSM2STATECOLUMNS_H
...
{
    struct QuestionSm2StateColumns : BaseColumns
    {
        QuestionSm2StateColumns() = delete;

        QuestionSm2StateColumns(const QuestionSm2StateColumns&) = delete;
        QuestionSm2StateColumns& operator=(const QuestionSm2StateColumns&) = delete;

        static constexpr const char* MODEL_NAME = "question_sm2_state";
...
#endif // QUESTIONSM2STATECOLUMNS_H
