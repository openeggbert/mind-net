...
namespace mindnet::model
{
    ...
    private:
        ...
        std::set<mindnet::core::Crudl> allowed_rest_operations; ///< Allowed CRUD operations for REST API
    ...
    public:
        ...
        [[nodiscard]] const std::set<mindnet::core::Crudl>& get_allowed_rest_operations() const
        {
         ...
         * @return Reference to this object for method chaining
         */
        ModelDefinition& set_rest_operations(std::set<mindnet::core::Crudl> ops)
        {
        ...
        ModelDefinition& set_rest_operations(std::string ops_as_string)
        {
            ...
            {
                mindnet::core::Crudl crudl = core::char_to_crudl(ch);
                if (crudl == mindnet::core::Crudl::Undefined)
                {
                    throw std::invalid_argument("Invalid value for allowed_rest_operations: ");
                }
        ...
        {
            return set_rest_operations(core::CRUDL);
        }
        ...
        [[nodiscard]] ModelDefinition& add_custom_list_action(
            ...
            const std::vector<std::string>& params_)
        {
            return add_custom_action(mindnet::core::Crudl::List, model_name_, label_, params_);
        }
        ...
        [[nodiscard]] ModelDefinition& add_custom_create_action(
            ...
            const std::vector<std::string>& params_)
        {
            return add_custom_action(mindnet::core::Crudl::Create, model_name_, label_, params_);
        }
    };
}
