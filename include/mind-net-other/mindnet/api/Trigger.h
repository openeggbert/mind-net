...
namespace mindnet::api
{
    ...
    public:
        ...
        using ListFn   = std::pair<std::vector<entity_fields>, OperationResult>(Service::*)(model::ModelDefinition&, http::LoginToken&, http::QueryParams&, int);
          ...
          Trigger(
            ...
            int priority_,
            const std::vector<mindnet::core::Crudl>& operations_,
            TriggerPhase phase_,
        ...
        //
        inline const std::vector<mindnet::core::Crudl>& get_operations() const { return operations; }
    ...
    private:
        ...
        int priority{};
        //
        std::vector<mindnet::core::Crudl> operations;
