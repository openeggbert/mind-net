 ...
 */
#ifndef FLAGCOLUMNS_H
#define FLAGCOLUMNS_H
...
{
    struct FlagColumns : model::BaseColumns
    {
        FlagColumns() = delete;

        FlagColumns(const FlagColumns&) = delete;
        FlagColumns& operator=(const FlagColumns&) = delete;
