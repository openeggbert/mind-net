...
///////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PINNED_NOTE_H
#define PINNED_NOTE_H
...
#include "../columns/PinnedNoteColumns.h"
// ***** MACROS : END *****
...
namespace mindnet::plugins::slipbox::models
{
    ...
    inline def PINNED_NOTE_DEFINITION =
        def(COLS::MODEL_NAME)
        .set_all_rest_operations()
        .set_group("Slip Box", 100)
        .set_columns({
            coldef(COLS::USER_ID, MANDATORY)
            .set_foreign_key("user")
            .set_description("User who pinned the note"),
            coldef(COLS::NOTE_ID, MANDATORY)
            .set_foreign_key("note")
