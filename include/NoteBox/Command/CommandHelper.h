...
namespace NoteBox::Command {
    ...
    private:
        ...
        std::shared_ptr<Persistence::DB>* db = nullptr;

    public:
        CommandHelper(NoteBox::Command::CommandFactory* factory, std::shared_ptr<Persistence::DB>* db);
        ...
        std::shared_ptr<Persistence::DB>* getDB() override;
