...
namespace mindnet::api
{
    ...
    public:
        ...
        read(const ModelDefinition& def, api::LoginToken& token, int id, int stack_depth = 0) ;
        OperationResult update(const ModelDefinition& def, api::LoginToken& token, int id,
                               entity_fields& fields, int stack_depth = 0) ;
        OperationResult remove(ModelDefinition& def, api::LoginToken& token, int id, int stack_depth = 0) ;
    ...
    private:
        ...
        OperationResult can_update(const ModelDefinition& model_definition, api::LoginToken& token,
                                   entity_fields& ef) override;
        OperationResult can_delete(const ModelDefinition& model_definition, api::LoginToken& token, int id) override;
        OperationResult can_list(const ModelDefinition& model_definition, api::LoginToken& token,
